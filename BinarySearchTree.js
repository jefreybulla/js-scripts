...
module.exports = class BinarySearchTree {
    ...
    // use # to indicate that this ia a private method (can only be called inside the class)
    ...
    #delete(currentNode, value) {
        ...
        // At this point currentNode is the Node to be deleted. 
        // Below we change child references as needed 
        if (currentNode === null) {
            return false;
